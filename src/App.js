...
import NewsHeadlineWidget from './widgets/NewsHeadlineWidget'
import InspirationalQuotesWidget from './widgets/InspirationalQuotesWidget'
import TaskWidget from './widgets/TaskWidget'
 
function App() {
 const [widgets, setWidgets] = useState([
  { id: new Date().getTime(), component: <NewsHeadlineWidget />, area: 'main-widget', name: "Headline" },
  { id: new Date().getTime() + 2, component: <InspirationalQuotesWidget />, area: 'right-widget', name: "Quotes" },
  { id: new Date().getTime() + 1, component: <TaskWidget />, area: 'left-widget', name:"Task Progress" },
 ])
